  ...
  epl: [
    {
      ...
      markets: [
        threeWay("epl-1", 2.55, 3.4, 2.8),
        spread("epl-1", -0.5, 1.91, 1.91),
        total("epl-1", 2.5, 1.8, 2.05),
      ],
    },
    {
      id: "epl-2",
      ...
      matchClock: "67'",
      markets: [
        threeWay("epl-2", 1.87, 4.2, 3.9),
        spread("epl-2", -1, 2.35, 1.65),
        total("epl-2", 3.5, 2.2, 1.65),
      ],
    },
  ],
  laliga: [
    {
      ...
      markets: [
        threeWay("laliga-1", 1.53, 4.3, 5.8),
        spread("laliga-1", -1.5, 2.1, 1.72),
        total("laliga-1", 2.5, 1.72, 2.1),
      ],
    },
  ],
  "serie-a": [
  ...
  ucl: [
    {
      ...
      markets: [
        threeWay("ucl-1", 1.74, 3.9, 4.6),
        spread("ucl-1", -0.5, 1.91, 1.91),
        total("ucl-1", 2.5, 1.77, 2.0),
      ],
    },
  ],
  nba: [
    {
      ...
      markets: [
        moneyline("nba-1", 1.77, 2.05),
        spread("nba-1", -2.5, 1.91, 1.91),
        total("nba-1", 225.5, 1.91, 1.91),
      ],
    },
    {
      id: "nba-2",
      ...
      matchClock: "6:42",
      markets: [
        moneyline("nba-2", 2.15, 1.74),
        spread("nba-2", 2.5, 1.91, 1.91),
        total("nba-2", 218.5, 1.91, 1.91),
      ],
    },
  ],
  euroleague: [
  ...
  atp: [
    {
      ...
      markets: [
        moneyline("atp-1", 1.91, 1.91),
        spread("atp-1", -1.5, 2.3, 1.62),
        total("atp-1", 35.5, 1.91, 1.91),
      ],
    },
  ],
  wta: [
...
export class MockSportsProvider implements SportsDataProvider {
  ...
  getLiveEvents(sportCode: string): Promise<ProviderFixture[]> {
    ...
    const live = competitionIds.flatMap((id) =>
      (FIXTURES[id] ?? []).filter((f) => f.status === "live"),
    );
