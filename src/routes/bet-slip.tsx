...
export const Route = createFileRoute("/bet-slip")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Review your picks and place your play-money bets on Betrix." },
      { property: "og:title", content: "Bet Slip — Betrix" },
      { property: "og:description", content: "Review your picks and place your play-money bets on Betrix." },
      ...
      <div className="mx-auto max-w-2xl">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">{slip.length} selection{slip.length === 1 ? "" : "s"}</p>
          </div>
          {slip.length > 0 && (
            <button
              onClick={clearSlip}
        ...
        {slip.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-2xl border border-border bg-card py-16 text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Add picks from upcoming events to get started.</p>
            <Link
              to="/sports"
              ...
              <div key={item.id} className="rounded-2xl border border-border bg-card p-5">
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center rounded-xl border border-border bg-background">
                    ...
                    <div className="min-w-[4rem] text-center text-base font-bold text-foreground">${item.stake}</div>
                    <button
          ...
          <div className="mt-10">
            ...
            <div className="space-y-3">
              {bets.slice(0, 5).map((bet) => (
                <div key={bet.id} className="flex items-center justify-between rounded-xl border border-border bg-card p-4">
                  <div>
