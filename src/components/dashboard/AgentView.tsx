  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <IdentifierTransferModal
        ...
        title={
          action
            ? `${action.mode === "topup" ? "Top up" : "Cash out"} ${action.player.username}`
            : ""
        }
        actionLabel={action?.mode === "topup" ? "Top up" : "Cash out"}
        amountLabel="Coins"
        rpcName={action?.mode === "topup" ? "transfer_agent_to_player" : "cashout_player_to_agent"}
        initialIdentifier={action?.player.accountId}
          ...
          <tbody>
            ...
            {players.map((p) => (
              ...
              >
                ...
                <td className="px-4 py-3">
                  <AccountIdBadge accountId={p.accountId} />
                </td>
